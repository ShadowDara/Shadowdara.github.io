...
title: 'Wifi Trick'
pubDate: 2025-10-16
tags: ["blog", "windows", "code", "trick"]
author: Shadowdara
description: "This is a simple trick to read the already saved / registrated wlan / wifi passwords from your computer"
---
...
You can although copy the code downbelow and safe it as a `.bat` file, after running, it will display all saved in the terminal, *but this is optional.* or download the file [here](https://raw.githubusercontent.com/ShadowDara/dotfiles/refs/heads/main/Snippets/Wifi-Trick/wifi-trick.bat)
...
or if something does not work etc. Send me an email at shadowdara74@gmail.com or a message on Discord at @shadowdara.
